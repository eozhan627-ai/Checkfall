...
/**
 * Rahmenfarbe des Profilbilds je nach Abo-Tarif.
 * WICHTIG: Die Tier-Strings ("diamond", "gold", "silver") sind eine Annahme —
 * bitte an die tatsächlichen Werte aus lib/account.ts (AccountType.vipTier) anpassen,
 * falls sie anders heißen.
 */
function getAvatarFrameColor(tier?: string | null): string {
    switch (tier) {
        case "diamond":
            return "#D4AF37"; // Gold-Ton, passt zum VIP-Teaser
        case "gold":
            return "#E0B84C";
        case "silver":
            return "#B9C2CC";
        default:
            return "rgba(91, 141, 184, 0.55)"; // bisherige Standardfarbe
    }
}
    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* VIP TEASER — nur für Nicht-Abonnenten. Bestehende Abonnenten
            verwalten ihr Abo jetzt im Profil statt hier auf der Startseite. */}
